...
@section('content')
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    @if ($exam->type == 'alhan' || $exam->type == 'Alhan')
                        <h1>امتحان الحان</h1>
                    @elseif($exam->type == 'coptic' || $exam->type == 'Coptic')
                        <h1>امتحان قبطى</h1>
                    @else
                        <h1>امتحان طقس</h1>
                    @endif
            ...
            <div class="card-body p-0">
                ...
                <div class="container-fluid">
                    <form action="{{ route('take-written-exam.update') }}" id="exam-selection" method="POST"
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <input type="number" min="0" step="0.1"
                                                    max="{{ $item->wight }}"
                                                    class="form-control input-named @if ($exam->type == 'coptic' || $exam->type == 'Coptic') scored-question @endif"
                                                    min="0" id="mark-{{ $key }}"
                        ...
                        @if ($exam->type == 'coptic' || $exam->type == 'Coptic')

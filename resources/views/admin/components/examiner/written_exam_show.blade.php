                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label class="m-1">
                                        <input type="radio" name="answers[{{ $key }}][score]" value="@if ($option->status == 1) {{ $item->wight }} @else  0 @endif">
                                    ...
                                    @endforeach
                                    @else
                                    <input type="number" min="0" step="0.1" max="{{ $item->wight }}" class="form-control input-named @if ($exam->type == 'coptic') scored-question @endif" min="0" id="mark-{{ $key }}" name="answers[{{ $key }}][score]" required value="{{ $item->score }}">
                                    @endif
                                </td>
                            </tr>
                            @endforeach

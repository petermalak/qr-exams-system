...
class CopticExamAttendancesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query): DataTableAbstract
    {
        return datatables()
            ...
            ->editColumn("coptic", function ($data) {
                return $data->coptic == 1 ? 'Examed' : 'Not Examed';
    ...
    public function query(ExamAttendance $model): Builder
    {
        ...
        $examStudents = BookingExams::all()->filter(function ($exam) use ($today) {
            ...
            return $examDate && $examDate->format('Y-m-d') === $today && $exam->type == 'coptic';
        ...
        return $model->newQuery()
            ...
            })->where('in_hall', 1)->where('coptic',0); // Ensure they are in the hall
    }
    ...
    {
        return 'CopticExamAttendances_' . date('YmdHis');
    }
}

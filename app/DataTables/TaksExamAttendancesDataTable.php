...
class TaksExamAttendancesDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query): DataTableAbstract
    {
        return datatables()
            ...
            ->editColumn("taks", function ($data) {
                return $data->taks == 1 ? 'Examed' : 'Not Examed';
    ...
    {
        return $model->newQuery()->where('taks',"Day2")->where('in_hall',1);
    }
    ...
    {
        return 'TaksExamAttendances_' . date('YmdHis');
    }
}
